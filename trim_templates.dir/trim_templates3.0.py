...
def read_input_par(trimfile):
    ...
    return stations, channels, networks, lowpassf, highpassf, tlen_bef, tlen_aft, UTC_prec, cont_dir, temp_dir, day_list, ev_catalog, start_itemp, stop_itemp, taup_model
