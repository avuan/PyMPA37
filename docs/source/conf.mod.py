...
project = 'PyMPA'
copyright = '2019, Alessandro Vuan and Monica Sugan'
...
latex_documents = [
    (master_doc, 'main.tex', 'PyMPA Python Matching Phase Algorithm Documentation',
     'Alessandro Vuan and Monica Sugan', 'manual')
]
...
man_pages = [
    (master_doc, 'pympa', 'PyMPA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyMPA', 'PyMPA Documentation',
     author, 'PyMPA', 'One line description of project.',
     'Miscellaneous'),
]
